...
// NO usar import/exports: D3 y dscc llegan como globals (window.d3 / window.dscc)
(function() {
  const d3   = window.d3;
  const dscc = window.dscc;

  function drawViz(data) {
    // 1. Prepara contenedor
    ...
    // 3. Márgenes y cálculo de ancho/alto
  ...
  // 10. Suscríbete a los datos de Looker Studio
